document.body.innerHTML = RegisterView();
RegisterEvent();
        ...
        <form id="form3">
            ...
            <div class="community-container">
                <ul class="ks-cboxtags">
                    ...
                    <li><input type="checkbox" id="checkboxFour" value="Moondancer"><label for="checkboxFour">Alcohol Abuse</label></li>
                    <li><input type="checkbox" id="checkboxFive" value="Surprise"><label for="checkboxFive">Addiction</label></li>
                </ul>
            </div>
            <h5>By click submit, you are agreeing to Vetted <a href="https://benice.com/">community guidelines.</a></h5>
            <br>
            <div class="btn-box">
